...
static esp_err_t index_handler(httpd_req_t *req){
 ...
 page += "<div style= background-color:black>";
 page += "<h1 style=color: white>Spy X Car</h1>";
 //page += "<p align=center><IMG SRC='http://" + WiFiAddr + ":81/stream' style='width:400px;'></p><br/><br/>";
 page += "<p align=center><IMG SRC='http://" + WiFiAddr + ":81/stream' style='width:400px; transform:rotate(180deg);'></p><br/><br/>";
 ...
 page += "<p align=center>";
 page += "<button style=background-color:lightblue;width:140px;height:40px onmousedown=getsend('ledon')><b>Light ON</b></button>";
 page += "<button style=background-color:lightblue;width:140px;height:40px onmousedown=getsend('ledoff')><b>Light OFF</b></button>";
 page += "</p>";
 page += "</div>";
